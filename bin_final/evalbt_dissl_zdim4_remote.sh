...
model_name=dissl_zdim4
base_dir="$model_name"_dir

./dev/launch_slurm.sh \
    $base_dir/augevalbt \
    config=benchmark/linear_image_classification/imagenet1k/eval_resnet_in1k_linear_z4_barlow \
    ...
    config.SLURM.PORT_ID=40013 \
    config.SLURM.NAME=augevalbt_"$model_name" \
