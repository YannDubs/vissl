...
def infer_losses_config(cfg):
    ...
    if "simclr_info_nce_loss" in cfg.LOSS.name or "cntr_issl_loss" in cfg.LOSS.name:
    ...
    if "dstl_issl_loss" in cfg.LOSS.name:
        ...
        cfg.LOSS.dstl_issl_loss.n_Mx = cfg.MODEL.HEAD.PARAMS[0][-1][1]["dims"][-1]
    ...
    if "dissl_reg_loss" in cfg.LOSS.name:
        ...
        cfg.LOSS.dissl_reg_loss.z_dim = cfg.MODEL.HEAD.PARAMS[1][0][1]["dims"][0]
