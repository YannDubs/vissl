...
python tools/linear_eval.py --feature-path "$dir"/features --out-path "$dir"/eval_w01_l01_b2048 --weight-decay 1e-7 --lr 0.1 --batch-size 2048 --is-no-progress-bar
python tools/linear_eval.py --feature-path "$dir"/features --out-path "$dir"/eval_w1_l01_b2048 --weight-decay 1e-6 --lr 0.1 --batch-size 2048 --is-no-progress-bar
